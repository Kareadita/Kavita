...
public class ChapterDto : IHasReadTimeEstimate, IHasCoverImage
{
    ...
    /// <inheritdoc cref="JSType.Number"/>
    [Obsolete("Use MinNumber and MaxNumber instead")]
    public string Number { get; init; } = default!;
    /// <inheritdoc cref="Chapter.MinNumber"/>
    public float MinNumber { get; init; }
    /// <inheritdoc cref="Chapter.MaxNumber"/>
    public float MaxNumber { get; init; }
    /// <inheritdoc cref="Chapter.SortOrder"/>
    public float SortOrder { get; set; }
    /// <inheritdoc cref="Chapter.Pages"/>
    public int Pages { get; init; }
    /// <inheritdoc cref="Chapter.IsSpecial"/>
    public bool IsSpecial { get; init; }
    /// <inheritdoc cref="Chapter.Title"/>
    ...
    /// <inheritdoc cref="Chapter.CoverImageLocked"/>
    public bool CoverImageLocked { get; set; }
    /// <inheritdoc cref="Chapter.VolumeId"/>
    public int VolumeId { get; init; }
    /// <inheritdoc cref="Chapter.CreatedUtc"/>
    public DateTime CreatedUtc { get; set; }
    /// <inheritdoc cref="Chapter.LastModifiedUtc"/>
    public DateTime LastModifiedUtc { get; set; }
    /// <inheritdoc cref="Chapter.Created"/>
    public DateTime Created { get; set; }
    /// <inheritdoc cref="Chapter.ReleaseDate"/>
    public DateTime ReleaseDate { get; init; }
    /// <inheritdoc cref="Chapter.TitleName"/>
    ...
    /// <inheritdoc cref="Chapter.WebLinks"/>
    ...
    /// <inheritdoc cref="Chapter.Count"/>
    public int Count { get; set; }
    /// <inheritdoc cref="Chapter.TotalCount"/>
    public int TotalCount { get; set; }

    /// <inheritdoc cref="Chapter.LanguageLocked"/>
    public bool LanguageLocked { get; set; }
    /// <inheritdoc cref="Chapter.SummaryLocked"/>
    public bool SummaryLocked { get; set; }
    /// <inheritdoc cref="Chapter.AgeRatingLocked"/>
    public bool AgeRatingLocked { get; set; }
    public bool PublicationStatusLocked { get; set; }
    /// <inheritdoc cref="Chapter.GenresLocked"/>
    public bool GenresLocked { get; set; }
    /// <inheritdoc cref="Chapter.TagsLocked"/>
    public bool TagsLocked { get; set; }
    /// <inheritdoc cref="Chapter.WriterLocked"/>
    public bool WriterLocked { get; set; }
    /// <inheritdoc cref="Chapter.CharacterLocked"/>
    public bool CharacterLocked { get; set; }
    /// <inheritdoc cref="Chapter.ColoristLocked"/>
    public bool ColoristLocked { get; set; }
    /// <inheritdoc cref="Chapter.EditorLocked"/>
    public bool EditorLocked { get; set; }
    /// <inheritdoc cref="Chapter.InkerLocked"/>
    public bool InkerLocked { get; set; }
    /// <inheritdoc cref="Chapter.ImprintLocked"/>
    public bool ImprintLocked { get; set; }
    /// <inheritdoc cref="Chapter.LettererLocked"/>
    public bool LettererLocked { get; set; }
    /// <inheritdoc cref="Chapter.PencillerLocked"/>
    public bool PencillerLocked { get; set; }
    /// <inheritdoc cref="Chapter.PublisherLocked"/>
    public bool PublisherLocked { get; set; }
    /// <inheritdoc cref="Chapter.TranslatorLocked"/>
    public bool TranslatorLocked { get; set; }
    /// <inheritdoc cref="Chapter.TeamLocked"/>
    public bool TeamLocked { get; set; }
    /// <inheritdoc cref="Chapter.LocationLocked"/>
    public bool LocationLocked { get; set; }
    /// <inheritdoc cref="Chapter.CoverArtistLocked"/>
    public bool CoverArtistLocked { get; set; }
    /// <inheritdoc cref="Chapter.ReleaseDateLocked"/>
    public bool ReleaseDateLocked { get; set; }
    /// <inheritdoc cref="Chapter.TitleNameLocked"/>
    public bool TitleNameLocked { get; set; }
    /// <inheritdoc cref="Chapter.SortOrderLocked"/>
    public bool SortOrderLocked { get; set; }

    #endregion

    /// <inheritdoc cref="Chapter.CoverImage"/>
    public string? CoverImage { get; set; }
    /// <inheritdoc cref="Chapter.PrimaryColor"/>
    public string? PrimaryColor { get; set; } = string.Empty;
    /// <inheritdoc cref="Chapter.SecondaryColor"/>
