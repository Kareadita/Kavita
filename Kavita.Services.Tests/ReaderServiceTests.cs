...
public class ReaderServiceTests(ITestOutputHelper testOutputHelper) : AbstractDbTest(testOutputHelper)
{
    ...
    public async Task GetNextChapterIdAsync_ShouldRollIntoNextChapter_WhenVolumesAreOnlyOneChapter_AndNextChapterIs0()
    {
       ...
       var library = new LibraryBuilder("Test Lib", LibraryType.Manga).Build();
        ...
        var actualChapter = await unitOfWork.ChapterRepository.GetChapterAsync(nextChapter);
        Assert.NotNull(actualChapter);
        Assert.Equal(Parser.DefaultChapter, actualChapter.Range);
    }
        ...
        var series = new SeriesBuilder("Test")
           .WithLibraryId(library.Id)
            ...
            .WithVolume(new VolumeBuilder(Parser.SpecialVolume)
                .WithChapter(new ChapterBuilder("A.cbz").WithIsSpecial(true).WithSortOrder(Parser.SpecialVolumeNumber).Build())
                .WithChapter(new ChapterBuilder("B.cbz").WithIsSpecial(true).WithSortOrder(Parser.SpecialVolumeNumber + 1).Build())
                .Build())
            .Build();
       ...
       var library = new LibraryBuilder("Test Lib", LibraryType.Manga).Build();
        ...
        var series = new SeriesBuilder("Test")
           .WithLibraryId(library.Id)
            ...
            .WithVolume(new VolumeBuilder(Parser.SpecialVolume)
                .WithChapter(new ChapterBuilder("A.cbz").WithIsSpecial(true).WithSortOrder(Parser.SpecialVolumeNumber + 1).Build())
                .WithChapter(new ChapterBuilder("B.cbz").WithIsSpecial(true).WithSortOrder(Parser.SpecialVolumeNumber + 2).Build())
                .Build())
            .Build();
    ...
    public async Task GetContinuePoint_ShouldReturnFirstNonSpecial2()
    {
        ...
        var series = new SeriesBuilder("Test")
            ...
            // One file volume
            .WithVolume(new VolumeBuilder("1")
                .WithChapter(new ChapterBuilder(Parser.DefaultChapter).WithPages(1).Build()) // Read
                .Build())
    ...
    public async Task GetContinuePoint_ShouldReturnFirstChapter_WhenHasSpecial()
    {
        ...
        var series = new SeriesBuilder("Test")
            ...
            .WithVolume(new VolumeBuilder(Parser.LooseLeafVolume)
                ...
                .Build())
            .WithVolume(new VolumeBuilder(Parser.SpecialVolume)
                .WithChapter(new ChapterBuilder("Prologue").WithIsSpecial(true).WithSortOrder(Parser.SpecialVolumeNumber + 1).WithPages(1).Build())
                .Build())
            .WithLibraryId(library.Id)
            .Build();
    ...
    public async Task GetContinuePoint_ShouldReturnFirstVolume_WhenHasSpecial_LightNovel()
    {
        ...
        var series = new SeriesBuilder("Test")
            ...
            .WithVolume(new VolumeBuilder("1")
                .WithChapter(new ChapterBuilder(Parser.DefaultChapter)
                    .WithSortOrder(Parser.DefaultChapterNumber).WithPages(1).Build())
                .Build())
            .WithVolume(new VolumeBuilder("2")
                .WithChapter(new ChapterBuilder(Parser.DefaultChapter)
                    .WithSortOrder(Parser.DefaultChapterNumber).WithPages(1).Build())
            ...
            .WithVolume(new VolumeBuilder("99.9")
                ...
                .Build())
            .WithVolume(new VolumeBuilder(Parser.SpecialVolume)
                .WithChapter(new ChapterBuilder(Parser.DefaultChapter, "Short Stories").WithIsSpecial(true)
    ...
    public async Task GetContinuePoint_ShouldReturnLooseChapter_WhenAllVolumesRead_HasSpecialAndLooseChapters_Unread()
    {
        ...
        var series = new SeriesBuilder("Test")
            ...
            .WithVolume(new VolumeBuilder(Parser.LooseLeafVolume)
                ...
                .Build())
            .WithVolume(new VolumeBuilder(Parser.SpecialVolume)
                .WithChapter(new ChapterBuilder("Christmas Eve").WithIsSpecial(true).WithSortOrder(Parser.SpecialVolumeNumber + 1).WithPages(1).Build())
                .Build())
    ...
    public async Task GetContinuePoint_ShouldReturnFirstSpecial_WhenAllReadAndAllChapters()
    {
        ...
        var series = new SeriesBuilder("Test")
            ...
            .WithVolume(new VolumeBuilder(Parser.LooseLeafVolume)
                ...
                .Build())
            .WithVolume(new VolumeBuilder(Parser.SpecialVolume)
                .WithChapter(new ChapterBuilder("Some Special Title").WithIsSpecial(true).WithSortOrder(Parser.SpecialVolumeNumber + 1).WithPages(1).Build())
                .Build())
            .Build();
    ...
    public async Task GetContinuePoint_ShouldReturnUnreadSingleVolume_WhenThereAreSomeSingleVolumesBeforeLooseLeafChapters()
    {
        ...
        var readChapter1 = new ChapterBuilder(Parser.DefaultChapter).WithPages(1).Build();
        var readChapter2 = new ChapterBuilder(Parser.DefaultChapter).WithPages(1).Build();
        var volume = new VolumeBuilder("3").WithChapter(new ChapterBuilder(Parser.DefaultChapter).WithPages(1).Build()).Build();
    ...
    public async Task GetContinuePoint_ShouldReturnLastLooseChapter()
    {
        ...
        var series = new SeriesBuilder("Test")
            ...
            .WithVolume(new VolumeBuilder(Parser.LooseLeafVolume)
                ...
                .Build())
            .WithVolume(new VolumeBuilder(Parser.SpecialVolume)
                .WithChapter(new ChapterBuilder("Special").WithIsSpecial(true).WithSortOrder(Parser.SpecialVolumeNumber + 1).WithPages(1).Build())
                .Build())
            .Build();
