...
public class ArchiveServiceTests
{
    ...
    public void CanExtractArchive(string archivePath, int expectedFileCount)
    {
        ...
        var testDirectory = Path.Join(Directory.GetCurrentDirectory(), "../../../Test Data/ArchiveService/Archives");
        var extractDirectory = Path.Join(Directory.GetCurrentDirectory(), "../../../Test Data/ArchiveService/Archives/Extraction");
    ...
    public void CanParseCoverImage(string inputFile)
    {
        ...
        var testDirectory = Path.Join(Directory.GetCurrentDirectory(), "../../../Test Data/ArchiveService/");
