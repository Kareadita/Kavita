...
public class MangaParserTests
{
    ...
    [InlineData("No Volume", API.Services.Tasks.Scanner.Parser.Parser.DefaultVolume)]
    ...
    [InlineData("Yumekui-Merry_DKThias_Chapter11v2.zip", API.Services.Tasks.Scanner.Parser.Parser.DefaultVolume)]
    [InlineData("Itoshi no Karin - c001-006x1 (v01) [Renzokusei Scans]", "1")]
    [InlineData("Kedouin Makoto - Corpse Party Musume, Chapter 12", API.Services.Tasks.Scanner.Parser.Parser.DefaultVolume)]
    ...
    [InlineData("Kedouin Makoto - Corpse Party Musume, Chapter 12 [Dametrans][v2]", API.Services.Tasks.Scanner.Parser.Parser.DefaultVolume)]
    [InlineData("Vagabond_v03", "3")]
    [InlineData("Mujaki No Rakune Volume 10.cbz", "10")]
    [InlineData("Umineko no Naku Koro ni - Episode 3 - Banquet of the Golden Witch #02.cbz", API.Services.Tasks.Scanner.Parser.Parser.DefaultVolume)]
    ...
    [InlineData("Noblesse - Episode 406 (52 Pages).7z", API.Services.Tasks.Scanner.Parser.Parser.DefaultVolume)]
