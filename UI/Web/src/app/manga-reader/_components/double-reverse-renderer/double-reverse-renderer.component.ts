...
export class DoubleReverseRendererComponent implements OnInit, ImageRenderer {
  ...
  protected readonly isValid = computed(() => this.layoutMode() === LayoutMode.DoubleReversed);
  ...
  ngOnInit(): void {
    ...
    this.pageNum$().pipe(
      ...
      tap(pageInfo => {
        ...
        this.leftImage = this.getPage()(pageInfo.pageNum);
        this.rightImage = this.getPage()(pageInfo.pageNum + 1);
  ...
  debugLog(message: string, extraData?: never) {
