...
export class ManageReadingProfilesComponent implements OnInit {
  ...
  setupForm() {
    ...
    this.readingProfileForm.addControl('webtoonScrollAmount', new FormControl(this.selectedProfile.webtoonScrollAmount || 85, [Validators.min(10), Validators.max(100)]));
