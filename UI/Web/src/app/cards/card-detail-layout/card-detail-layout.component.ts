...
import {
  ...
  FilterItem,
  SeriesFilter,
} from 'src/app/_models/series-filter';
...
export class CardDetailLayoutComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.trackByIdentity = (index: number, item: any) =>
      `${this.header}_${this.pagination?.currentPage}_${this.updateApplied}_${item?.libraryId}`;
