...
export class BookService {
  ...
  getFontFamilies(): Array<FontFamily> {
    ...
    {title: 'Nanum Gothic', family: 'Nanum_Gothic'}, {title: 'Open Dyslexic', family: 'OpenDyslexic2'}, {title: 'RocknRoll One', family: 'RocknRoll_One'}, {title: 'Fast Font Serif', family: 'FastFontSerif'}, {title: 'Fast Font Sans', family: 'FastFontSans'}];
  }
