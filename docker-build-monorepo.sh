...
echo "Application build finished. Now run 'docker buildx build -t magujun/kavita:<platform> --platform linux/[amd64 | arm/v7 | arm64] . --push' to build the docker container"
